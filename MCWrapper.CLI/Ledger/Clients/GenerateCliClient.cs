...
namespace MCWrapper.CLI.Ledger.Clients
{
    public class GenerateCliClient : CliClient
    {
        ...
        public Task<CliResponse<object>> SetGenerateAsync(string blockchainName, bool generate, int gen_proc_limit) =>
            TransactAsync<object>(blockchainName, GenerateAction.SetGenerateMethod, new[] { $"{generate}".ToLower(), $"{gen_proc_limit}" });
